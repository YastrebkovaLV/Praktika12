        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                if (choose == 2)
                {
                    ...
                    Console.WriteLine(" Задание 2 сделано, нажмите на любую кнопку, чтобы вернуться к списку задач");
                }
                ...
                {
                    Console.WriteLine(" Задание 3 законченое, нажмите на любую клавишу");
                }
                ...
                if (choose == 10)
                {
                    ...
                    static string ConvertToBinary(int number)
                    {
                        ...
                        while (number > 0)
                        {
                            ...
                            Console.WriteLine(" Задание 10 закончено , нажмите на любую клавишу");
                        }
